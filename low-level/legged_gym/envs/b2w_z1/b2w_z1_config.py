...
#         file = '{LEGGED_GYM_ROOT_DIR}/resources/robots/b2w_z1/urdf/b2w_z1.urdf'
#         # name = "b2w_z1"
...
#     class rewards:
#         reward_container_name = "b2w_rewards"   # select the reward container to use
...
class B2WZ1RoughCfgPPO(LeggedRobotCfgPPO):
    ...
    class policy:
        ...
        adaptive_arm_gains = B2WZ1RoughCfg.control.adaptive_arm_gains
    ...
    class algorithm:
        ...
        torque_supervision = B2WZ1RoughCfg.control.torque_supervision  #alert: also appears above
